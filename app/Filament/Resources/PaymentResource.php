...
class PaymentResource extends Resource
{
    ...
    public static function getApplicationDetails(): Forms\Components\Component
    {
        return Forms\Components\Group::make([
                ...
                ->searchable()
                ->columnSpan(1)
                ->getSearchResultsUsing(fn (string $search): array => CustomerApplication::getSearchUnreleasedApplications($search)->get()->pluck('id', 'applicant_firstname'. "applicant_lastname")->toArray())
